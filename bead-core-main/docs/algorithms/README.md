...
```
createBeadPrepPixels            拼豆专用图（见 bead-prep.md）
createPixelArtPrepPixels        像素风中间图（见 pixel-art-prep.md）
        ↓
...
| [bead-prep.md](./bead-prep.md) | `prep/beadPrep.ts` | 拼豆专用图生成 |
| [pixel-art-prep.md](./pixel-art-prep.md) | `prep/pixelArtPrep.ts` | 经典最近邻像素风中间图 |
